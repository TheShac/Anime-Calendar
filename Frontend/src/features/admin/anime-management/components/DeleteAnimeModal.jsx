...
export default function DeleteAnimeModal({ open, anime, onClose, onConfirm }) {
  return (
    <Modal isOpen={open} onClose={onClose} maxWidth="max-w-sm">
      <div style={{ padding: "28px" }}>
        ...
        <p style={{ fontSize: "14px", color: "#71717a", lineHeight: "1.6", marginBottom: "24px" }}>
          ¿Estás seguro que deseas eliminar <span style={{ color: "#f0f0f0", fontWeight: 700 }}>{anime?.title}</span>? Esta acción no se puede deshacer.
        </p>
